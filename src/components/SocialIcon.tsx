    ...
    case "whatsapp":
      return (
        ...
        >
          ...
          <path d="M9.5 9.5c.3-.3.8-.3 1.1 0l1.2 1.2c.3.3.3.8 0 1.1l-.6.6c.5 1 1.4 1.9 2.4 2.4l.6-.6c.3-.3.8-.3 1.1 0l1.2 1.2c.3.3.3.8 0 1.1l-.8.8c-.8.8-2 .9-3 .3-2.6-1.5-4.7-3.6-6.2-6.2-.6-1-.5-2.2.3-3z" />
        </svg>
      );
    default:
      return null;
